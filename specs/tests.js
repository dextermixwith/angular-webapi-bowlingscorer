describe("ScoreCardController", function() {
    ...
    describe("Total for turn is 10 (spare) - ", function() {
        ...
        it("should show total score as 21 when 5, 5, 5 then 1 entered", function() {
            $controller('ScoreCardController', { $scope: $scope });
        ...
        it("should show total score as 15 when 5, 5, 5 then 5 entered", function() {
            $controller('ScoreCardController', { $scope: $scope });
        ...
        it("should show total score as 30 when 5, 5, 5, 5 then 5 entered", function() {
            $controller('ScoreCardController', { $scope: $scope });
        ...
        it("should show total score as 37 when 5, 5, 5, 5, 5 then 2 entered", function() {
            $controller('ScoreCardController', { $scope: $scope });
    ...
    describe("Strike is scored (10 in one roll) - ", function() {
       ...
       it("should show a total score as 8 and turn scores of 'X' and '8' when X scored on first roll, then 3 and 5", function() {
            $controller('ScoreCardController', { $scope: $scope });
            $scope.enterPlayerScore(0, 0, 'X');
            $scope.enterPlayerScore(1, 0, '3');
            $scope.enterPlayerScore(1, 1, '5');
       ...
       it("should show a total score as 0 when X scored on first roll, then 5 and 5", function() {
            $controller('ScoreCardController', { $scope: $scope });
       ...
       it("should show a total score as 14 and turn scores of 'X' and '/' when X scored on first roll, then 5, 5 and 4", function() {
            $controller('ScoreCardController', { $scope: $scope });
            $scope.enterPlayerScore(0, 0, 'X');
            $scope.enterPlayerScore(1, 0, '5');
            $scope.enterPlayerScore(1, 1, '5');
       ...
       it("should show a total score as 36 and turn scores of 'X', 'X' and '8' when X scored on first roll, then X, 4 and 4", function() {
            $controller('ScoreCardController', { $scope: $scope });
            $scope.enterPlayerScore(0, 0, 'X');
       ...
       it("should show a total score as 50 when X scored on first roll, then 6, 4 and X", function() {
            $controller('ScoreCardController', { $scope: $scope });
            $scope.enterPlayerScore(0, 0, 'X');
       ...
       it("should show total score as 300 when 'X' entered for all rolls plus an extra roll of 'X' in turn 10", function() {
            $controller('ScoreCardController', { $scope: $scope });
            for(var turnIndex = 0; turnIndex < 10; turnIndex++){
                $scope.enterPlayerScore(turnIndex, 0, 'X');
            }
